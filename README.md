...
> Use NovaPAI in cURL — OpenAI-compatible API gateway for DeepSeek V4 Pro & 50+ LLMs. Change one line of code, switch to any model.
...
All examples are in `example.sh`:
